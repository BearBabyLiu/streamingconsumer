...
/**
  ...
  */
case class ZkService(topic: String, zkServers: String) {
  ...
  /**
    ...
    * @return
    */
  def calculateCunsumerOffset(brokerHost: String, brokerPort: Int): Map[TopicAndPartition, Long] = {
